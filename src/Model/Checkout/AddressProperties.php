...
/**
 * AddressProperties Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\Api\V3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressProperties implements ModelInterface, ArrayAccess
{
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^\\+?[1-9]\\d{1,14}(x\\d{1-5})?$/", $phone))) {
            throw new \InvalidArgumentException("invalid value for $phone when calling AddressProperties., must conform to the pattern /^\\+?[1-9]\\d{1,14}(x\\d{1-5})?$/.");
        }
