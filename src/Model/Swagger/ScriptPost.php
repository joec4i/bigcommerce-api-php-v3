...
class ScriptPost implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['html']) && (mb_strlen($this->container['html']) > 65535)) {
            $invalidProperties[] = "invalid value for 'html', the character length must be smaller than or equal to 65535.";
        }

        if (!is_null($this->container['src']) && (mb_strlen($this->container['src']) > 255)) {
            $invalidProperties[] = "invalid value for 'src', the character length must be smaller than or equal to 255.";
        }
    ...
    {
        if (!is_null($html) && (mb_strlen($html) > 65535)) {
    ...
    {
        if (!is_null($src) && (mb_strlen($src) > 255)) {
