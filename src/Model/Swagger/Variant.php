...
class Variant implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sku' => 'string',
        'sku_id' => 'int',
        'option_values' => '\BigCommerce\Api\V3\Model\Swagger\OptionValueVariant[]',
     ...
     * Gets option_values
     *
     * @return \BigCommerce\Api\V3\Model\Swagger\OptionValueVariant[]
     */
     ...
     * Sets option_values
     *
     * @param \BigCommerce\Api\V3\Model\Swagger\OptionValueVariant[] $option_values Array of option and option values IDs that make up this variant. Will be empty if the variant is the product's base variant.
     *
     * @return $this
     */
