...
class PriceRecord implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'retail_price' => 'double',
        'map_price' => 'double',
        'bulk_pricing_tiers' => '\BigCommerce\Api\V3\Model\Swagger\BulkPricingTier[]',
        'sku' => 'string',
        'price_list_id' => 'int',
        'variant_id' => 'int',
        'currency' => 'string',
     ...
     *
     * @return \BigCommerce\Api\V3\Model\Swagger\BulkPricingTier[]
     */
     ...
     *
     * @param \BigCommerce\Api\V3\Model\Swagger\BulkPricingTier[] $bulk_pricing_tiers bulk_pricing_tiers
     *
     * @return $this
     */
