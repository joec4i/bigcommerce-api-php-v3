...
class Theme implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'variations' => '\BigCommerce\Api\V3\Model\Swagger\Variation[]',
        'uuid' => 'string',
        'name' => 'string',
        'is_private' => 'bool'
    ];
     ...
     * Gets variations
     *
     * @return \BigCommerce\Api\V3\Model\Swagger\Variation[]
     */
     ...
     * Sets variations
     *
     * @param \BigCommerce\Api\V3\Model\Swagger\Variation[] $variations The variations.
     *
     * @return $this
     */
