...
class ProductVideoPost implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['video_id']) && (mb_strlen($this->container['video_id']) > 25)) {
            $invalidProperties[] = "invalid value for 'video_id', the character length must be smaller than or equal to 25.";
        }

        if (!is_null($this->container['video_id']) && (mb_strlen($this->container['video_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'video_id', the character length must be bigger than or equal to 0.";
        }
    ...
    {
        if (!is_null($video_id) && (mb_strlen($video_id) > 25)) {
        ...
        if (!is_null($video_id) && (mb_strlen($video_id) < 0)) {
